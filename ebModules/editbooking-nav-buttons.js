...
(function () {
    ...
    window.sptGetSettings(function (settings) {
        if (settings.enableEditBookingButtons) (function() {
            ...
            function duplicateAndModifyButtons() {
                // Select the existing update button div
                let updateButtonDiv = document.querySelector(".col-xxl-2.col-xl-2.col-md-2.col-sm-12.mt-20");
            ...
            window.addEventListener("load", duplicateAndModifyButtons);
        })();
    });
})();
